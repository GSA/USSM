    ...
    <div class="grid-container">
        <div class="grid-row">
            <div class="tablet:grid-col-6 tablet:grid-offset-1 padding-top-4 tablet:padding-right-3 display-flex flex-column">
              ...
              Begin here - Find solutions and get help:<BR>
    ...
    if (!video.paused && !video.ended) {
     ...
     <!-- Data and Business Standards -->
                ...
                <div class="display-flex flex-align-center">
                  ...
                  <p>
                    Effective stewardship of taxpayer funds is a responsibility of the Federal Government and the Chief Financial Officer.  Federal agencies manage <B>over $6.7 trillion in annual spending</B><sup>1</sup>.  Common goals and objectives include:
                </p>
...
<BR><BR>
<sup>1</sup>Source:<A HREF="https://www.cbo.gov/topics/budget" STYLE="font-size:7px;">Congressional Budget Office, 2024</A>
