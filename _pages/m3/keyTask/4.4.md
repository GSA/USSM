...
activities:
  ...
  - text: Validate and update the Business Process Realignment Strategy
    responsibleParty: shared
  - text: Validate process decomposition for in-scope processes based on <A HREF="https://ussm.gsa.gov/fibf">Service Area functions and activities</A>
    responsibleParty: shared
  ...
  - text: Desk Guides/User Guide for customer and provider processes; Update Standard Operating Procedures (SOPs)
    responsibleParty: shared
  - text: Update/validate SLAs to ensure process steps are met that allow customers to meet agreed SLAs with provider
    responsibleParty: shared
