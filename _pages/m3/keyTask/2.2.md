...
objective: Update modernization Life Cycle Cost Estimate using Phase 1 and provider cost estimates to inform budget planning.
...
activities:
  ...
  - text: Update LCCE for all future phases
    responsibleParty: customer
  - text: Report cost/spending changes to leadership meetings & Reports/Dashboards; inform stakeholders
    responsibleParty: customer 
