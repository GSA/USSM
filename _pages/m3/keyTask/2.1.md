...
activitiesGroups:
  ...
  - group: 'Commercial Solutions (e.g. Commercial SaaS, Commercial Transaction Processing Services) follow these additional steps:'
    activities:
    - text: Draft Request for Proposal (RFP) for Phase 3 with optional tasks for Phases 4 and 5. 
      responsibleParty: customer
    - text: Refer to Task Order Guidance in Designated Areas<BR> • (<A HREF="https://acquisitiongateway.gov/shared-services/resources/4216?_a%5Eg_nid=11097">Grants Management Agency Acquisition Guide</A> (login.gov account required) &nbsp;&nbsp;&nbsp;• <A HREF="https://acquisitiongateway.gov/shared-services/resources/4215?_a%5Eg_nid=293">Financial Management Acquisition Process</a>)
      responsibleParty: customer
