...
activitiesGroups:
  ...
  - group: 'For Commercial Solutions (Commercial SaaS, Transaction Processing, etc) follow additional steps:'
    activities:
    - text: Draft Request for Proposal (RFP) in accordance with task order review guidance for Phase 3 with optional tasks for Phases 4 and 5; 
      responsibleParty:
        - customer
        - qsmo
    -text: If solution
