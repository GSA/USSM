...
activities:
  ...
  - text: Develop Workforce Transition Strategy
    responsibleParty: customer
  - text: Evaluate provider organization workforce based on customer migration and determine if there are impacts to provider workforce and Organization Structure
    responsibleParty: shared
