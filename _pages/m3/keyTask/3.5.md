...
activities:
  - text: Draft initial Implementation Approach and Integrated Master Schedule based on Requirements (RTM) / timeline
    responsibleParty: shared
  - text: Finalize Implementation Approach and release plan based on Business Readiness Assessment & Scope of Services
    responsibleParty: provider
  - text: Update Decommission Plan for system decommissioning post migration
    responsibleParty: customer
  - text: Develop design of the retained organization
    responsibleParty: customer
  - text: 'Develop Go/No-Go Criteria to assess readiness for Go-Live. Criteria may include readiness of program, system, workforce & operations'
    responsibleParty: shared
