...
activities:
  - text: Develop Test Plans and Scripts (Integration, System, Regression, Performance/Stress, User Acceptance, 508, Smoke)
    responsibleParty: shared
  ...
  - text: Perform regression test
    responsibleParty: shared
  - text: Develop Test Results Report for each test cycle, confirm exit criteria have been met, and document results in RTM
    responsibleParty: shared
