...
documentation_intro: 'The following documentation is typically developed during Phase 2. Agencies purchasing only transaction processing services will identify activities and examples for their project using the <a href="/assets/files/Services-Tailoring-Guide.xlsx">Services Tailoring Guide</a>.'
