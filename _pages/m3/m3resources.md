  ...
  - name: M3 Document and Example Tracker
    ...
    items:
      - name: M3 Examples MAX Page
        external_url: login.max.gov/cas/login?service=https%3A%2F%2Fcommunity.max.gov%2Flogin.action%3Fos_destination%3D%252Fpages%252Fviewpage.action%253FspaceKey%253DGSA%2526title%253DM3%252BArtifact%252BSamples
      - name: M3 Document and Example Tracker
