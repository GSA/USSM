...
Framework: GSA engaged agencies, providers, and Quality Service Management Offices to establish a performance framework considerate of Finance, Customer Satisfaction, Data and Process Standards Adoption, Operations, Information Technology, and Organizational maturity.
...
Marketplace Performance (Max Login Required): Marketplace and QSMO performance data aligned to the Marketplace Performance Management Framework.  Data for this dashboard was obtained through two channels 1) collected via the FY24 Annual OSSPI Customer Satisfaction Survey and 2) provided directly from each QSMO.
<BR><BR>
Customer Satisfaction Survey (Login.gov with .Gov email Required): This survey pulses agency management, operations, and administration offices on their satisfaction levels with operations, customer service, technology, and the cost of the services they use.
<BR><BR>
National Finance Center Performance: In response to on-going interest in improving the payroll ecosystem and in alignment with the 2023 NAPA Report on the National Finance Center (NFC), GSA partnered with OPM and USDA to assess NFC performance baseline across dimensions of Finance, Customer, Operations, Technology, Organization, and HR / Payroll.
<BR><BR>
