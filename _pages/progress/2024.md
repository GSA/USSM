      ...
      <tbody>
        <tr>
          <td style="border: 0;">
              ...
              <ul>
            <li><a href="#annualdatabusinessstandards">2024 Data & Business Standards Update</a></li>
            ...
            <li><a href="#emerging">Emerging Service Areas - FOIA, EEO, Mail</a></li>
              ...
              <p><b><a href="#fundingcost">Funding and Cost</a></b></p>
              <ul>
            <li><a href="#costrecovery">Cost Recovery Optimization</a></li>
             </ul>
              <p><b><a href="#governance">Governance and Priority Setting</a></b></p>
              <ul>
            <li><a href="#priorityinterests">Priority Interests</a></li>
            <li><a href="#coffa">COFFA</a></li>
              </ul>
              <p><b><a href="#performancemanagement">Performance Management</a></b></p>
              <ul>
            <li><a href="#pmf3">Performance Management Framework Phase 3</a></li>
            <li><a href="#pmfmarketplace">Marketplace Performance</a></li>
            <li><a href="#pmfcsat">Marketplace Performance</a></li>
            <li><a href="#pmfnfc">NFC Performance Pilot</a></li>
              </ul>
          </td>
          <td valign="top" style="border: 0;">
            <p><b><a href="#agencymodernization">Agency Planning and Modernization</a></b></p>
            <p><b><a href="#developerhub">Developer Hub</a></b></p>
            <p><b><a href="#partnernews">Bonus: Partner Progress</a></b></p>
...
<BR><BR>
<B id="priorityinterests">(a) Priority Interests</B><BR>
