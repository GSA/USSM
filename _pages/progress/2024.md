...
A baseline capability set for the information technology and cybersecurity stack in shared and centralized services were published by GSA through a process that included agency partners and industry (through public comment).  The capability set is first being used by the Department of Treasury and GSA to identify cloud and Software as a Service financial management technologies used to manage plan, manage, and report on agency spending.
<BR><BR>
