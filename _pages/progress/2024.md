...
<BR><BR>
<B>(c)</B> <A HREF="https://d2d.gsa.gov/report/shared-services-satisfaction-survey">2024 Customer Satisfaction</A> (.Gov email Required)<BR>This survey pulses agency management, operations, and administration offices on their satisfaction levels with operations, customer service, technology, as well as the cost and value of the services they use.
<BR><BR>
...
-->
        ...
        <div class="grid-row padding-bottom-5 style="background-color: lightblue;"">
            <div class="tablet:grid-col-10 grid-offset-1" style="display: flex; flex-direction: row; flex-wrap: wrap; background-color: lightblue;" >
                <h3>
